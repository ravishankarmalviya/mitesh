<?php
namespace Drupal\commom\Controller;
...
//select records from table
    $query = \Drupal::database()->select('commom', 'm');
      $query->fields('m', ['id','name','mobilenumber','email','age','gender','website']);
      $results = $query->execute()->fetchAll();
        $rows=array();
    foreach($results as $data){
        $delete = Url::fromUserInput('/commom/form/delete/'.$data->id);
        $edit   = Url::fromUserInput('/commom/form/mydata?num='.$data->id);
